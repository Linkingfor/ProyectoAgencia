/* ════════════════════════════════════════════════════
   "Mi cuenta" del cliente + Compra online (Sprint 5)
   ════════════════════════════════════════════════════
   Endpoints que usa la página comercial cuando el cliente ya
   está logueado. Aquí pasa lo bonito:

     - misReservas / misCompras → muestran lo que el cliente ya tiene.
     - comprarOnline           → flujo completo de compra:
         1) Valida cupos como en una reserva normal.
         2) Si pagó con tarjeta, VERIFICA en Stripe que el pago esté OK
            (status 'succeeded' + monto exacto + moneda correcta).
         3) Crea reserva CONFIRMADA, venta PAGADA, comprobante numerado.
         4) Devuelve el numero_comprobante y el id_venta para descargar PDF.

   Nota de seguridad: nunca confiamos en el precio o cantidad que envía
   el cliente para cobrar — el total real lo calcula el servidor.
   ════════════════════════════════════════════════════ */
...
/* ════════════════════════════════════════════════════
   Compra online — pasarela de pagos (simulada)
   ════════════════════════════════════════════════════ */
