...
import {
  ...
  CheckCircle2, Lock, ArrowRight, Receipt, Download, Sparkles, ShieldCheck
} from 'lucide-react';
...
export default function Compra({ paquete, onClose }) {
  ...
  // Pide la disponibilidad al backend (endpoint público requiere ser cliente logueado para /reservas/disponibilidad; uso un check local)
  ...
  // Cuando el usuario entra al paso 2 con método tarjeta, crea el PaymentIntent en Stripe
  useEffect(() => {
  ...
  // Pago alternativo (Yape/Plin/transferencia) — sin Stripe, registra directo
...
/* ── Sub-componente: el formulario de tarjeta de Stripe (dentro de <Elements>) ── */
