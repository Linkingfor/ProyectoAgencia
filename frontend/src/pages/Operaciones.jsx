...
// Descarga del comprobante PDF (RF-07)
...
/* ════════════════════════════════════════════════════
   SALIDAS — Programación de salidas + asignación de personal
   ════════════════════════════════════════════════════ */
const TURNOS = {
...
/* ════════════════════════════════════════════════════
   RESERVAS — con validación de capacidad (RF-04)
   ════════════════════════════════════════════════════ */
const estadoR = {
...
export function Reservas() {
  ...
  const [salidas, setSalidas]   = useState([]);
  const [modal, setModal]       = useState(false);
  const [form, setForm]         = useState({ id_cliente: '', id_servicio: '', fecha_servicio: '', cantidad_personas: 1, id_salida: '', observaciones: '' });
  ...
  const openCreate = () => {
    setForm({ id_cliente: '', id_servicio: '', fecha_servicio: '', cantidad_personas: 1, id_salida: '', observaciones: '' });
...
/* ════════════════════════════════════════════════════
   PAGOS — Registro de pagos físicos
   ════════════════════════════════════════════════════ */
export function Pagos() {
  ...
  // Reservas confirmadas/pendientes aún sin pagar (heurística: sin venta del mismo total)
